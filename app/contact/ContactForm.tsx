...
export default function ContactForm(){
  ...
  return (
    <form className="space-y-6" onSubmit={handleSubmit} aria-describedby="privacy-note" noValidate>
  ...
  <button type="submit" className="btn disabled:opacity-50" disabled={loading}>{loading ? 'Transmitting…' : 'Transmit'}</button>
